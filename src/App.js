  ...
  render(){
    return(
      ...
      <Router>
        ...
        <Route exact path="/actual" render={() => <MTable totalItems={this.state.gifs.length} data={this.state.gifs} fetchData={this.fetchGif} rowJSX={this.rowJSX} onChangee={this.onChangee} />} />
